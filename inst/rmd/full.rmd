...
```{r WRANGLE_DATA}
  ...
  ## Global Options Otuput

  logger::log_debug(paste0("params$filtered_devices in rmd = ", params$filtered_devices))

  message(str(
    paste0("params$filtered_devices = ", params$filtered_devices)
  ))
  
  message(str(
    paste0("params$filtered_weather = ", params$filtered_weather)
  ))
  
  message(str(
    paste0("params$filtered_obs = ", params$filtered_obs)
  ))
    
  message(str(
    paste0("params$filtered_interv = ", params$filtered_interv)
  ))
  ...
  sysOut <- Sys.getenv()
  message(str(
    paste0("sysOut = ", sysOut)
  ))
    
  logger::log_debug(paste0(sysOut))
  logger::log_debug(paste0("params$filtered_devices in rmd = ", params$filtered_devices))
  
  message(str(
    params$filtered_devices
  ))
  ...
  logger::log_debug(paste0("wrangled_devices after wrangle_devices function = ", wrangled_devices))

  ## Print out Wrangled_devices structure (dataframe or NULL)
  message(str(
    wrangled_devices
  ))
  ...
  ## Gloabl Options Otuput
  sysOut <- Sys.getenv()
  logger::log_debug(paste0("sysOut = ", sysOut))
