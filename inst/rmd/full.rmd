...
```{r WRANGLE_DATA}
  ...
  tryCatch(
    ...
    error = function(cond) {
      logger::log_debug(paste0("error conditinon = ", cond))
      tb <- traceback()
      logger::log_debug(tb)
    }
  )
