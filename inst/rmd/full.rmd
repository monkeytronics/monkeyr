...
```{r WRANGLE_DATA}
  ...
  # message(paste0("params$filtered_devices = ", params$filtered_devices))
  # message(paste0("params$filtered_weather = ", params$filtered_weather))
  # message(paste0("params$filtered_obs = ", params$filtered_obs))
  # message(paste0("params$filtered_interv = ", params$filtered_interv))
  # message(paste0("working dir = ", getwd()))

  # logger::log_debug(paste0("params$filtered_devices in rmd = ", params$filtered_devices)) # goes to cloudwatch.
  # message(params$filtered_devices)

  message(paste0("MESSAGE OUT : params = ", params))
  message(paste0("MESSAGE OUT : working dir = ", getwd())) 
  message(paste0("MESSAGE OUT : params$filtered_devices in rmd = ", params$filtered_devices))
  logger::log_debug(paste0("working dir = ", getwd())) 
  # logger::log_debug(paste0("params$filtered_devices in rmd = ", params$filtered_devices))
  ...
  logger::log_debug(paste0("wrangled_devices in rmd = ", wrangled_devices))
  ls_result <- ls()
  ...
  tryCatch(
  {
    ...
    logger::log_debug(paste0("wrangled_weather nrow = ", nrow(wrangled_weather)))
    ...
    error = function(cond) {
      logger::log_debug(paste0("error condition = ", cond))
      tb <- traceback()
      logger::log_debug(tb)
    }
  )
