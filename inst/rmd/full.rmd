...
params:
  ...
  fromTimeStamp:            1685996784   
  toTimeStamp:              1688588784
---
...
```{r WRANGLE_DATA, echo=FALSE}
  ...
  tryCatch(
    { 
      ...
      monkey_knit_msg(msg = paste0("wrangled_weather nrow = ", nrow(wrangled_weather)), resource="full.rmd, WRANGLE_DATA")
      ...
      ## Use Random Numbers to Verify Results
      ## Did this and looked fine!
      ## ------------------------------------
      ## 1. Fudge with white noise - Corellation should be 0. Works!
      # wrangled_obs$val <- sample(100, size = nrow(wrangled_obs), replace = TRUE)
      ## 2. Fudge with exact offset - Corellation should be 1. Works!
...
### Reporting period : `r date_string(minTs)` - `r date_string(maxTs)`
