...
params:
  ...
  report_params:            "intro,intervention analys,show deployment map,room anlys,tenure anlys,buildingType anlys,direction anlys,Analyse My Cool Project group,Analyse WISE group"                                            
  fromTimeStamp:            1656068313
  toTimeStamp:              1656759513
---
...
```{r setup, include=FALSE}
  ...
  # CloudWatch Logs
  message(paste0("\nMESSAGE OUT : params = ", params))
  message(paste0("\nMESSAGE OUT : working dir = ", getwd())) 
  message(paste0("\nMESSAGE OUT : params$filtered_devices in rmd = ", params$filtered_devices))
...
```{r, echo=FALSE, results='asis'}
  if ("deployment map" %in% param_list) {
