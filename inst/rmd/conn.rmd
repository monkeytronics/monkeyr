...
# Zero Readings Heat Maps {data-width=700}
...
## Get Expiry for each device
  ...
  zero_histogram_1 <-
    ...
    geom_histogram( binwidth=10, fill="#4953f2", color="#e9ecef", alpha=0.4) +
    ...
    scale_x_continuous(breaks=seq(floor(min(zero_readings$device_id)/100)*100, ceiling(max(zero_readings$device_id)/100)*100, by=100)) + # Adjust 'by' for resolution
