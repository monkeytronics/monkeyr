...
params:
  ...
  report_params:            "-map-"                                            
  fromTimeStamp:            1686608691
  toTimeStamp:              1686695091
---
  ...
  tryCatch(
    {
      ...
      ## Flag missing info
        dplyr::mutate(fw_ver           = tidyr::replace_na(fw_ver,      "NC")) %>%
      ...
      kable_summary <-
        wrangled_devices_3 %>%
        kableExtra::kbl(col.names = c("School", "IEM (Installed)", "IEM (Old FW)", "% (Old FW)", "Need Attn"),
                        format = "html",
                        align = "lcccr") %>%
