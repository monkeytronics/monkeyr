...
Of `r` deployed devices, `r` (shown in green) connected successfully, with approximate locations. Those in red were connected less than 25% of the time, so are excluded from the analysis.  `r` devices were excluded due to missing location data.
