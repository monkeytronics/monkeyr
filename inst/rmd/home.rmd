...
params:
  filtered_obs:             "../dummy-data/monkey_32/obs.csv"
  filtered_weather:         "../dummy-data/monkey_32/weather.csv"
  filtered_devices:         "../dummy-data/monkey_32/dev.csv"
  filtered_interventions:   "../dummy-data/monkey_32/interv.csv"
  report_params:            "-map-"                                            
