...
params:
  filtered_obs:             "../dummy-data/mark_h/obs.csv"
  filtered_weather:         "../dummy-data/mark_h/weather.csv"
  filtered_devices:         "../dummy-data/mark_h/dev.csv"
  filtered_interventions:   "../dummy-data/mark_h/interv.csv"
  report_params:            "-map-"                                            
  fromTimeStamp:            1654292001
  toTimeStamp:              1656884001
---
