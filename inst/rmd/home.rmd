...
monkeyr::set_options(observations = wrangled_obs)
...
`r if(getOption("CO2_ENABLE")){"### CO2"}`
```{r}
if (getOption("CO2_ENABLE")) {
  monkeyr::ts_chart(
    observations = wrangled_obs,
    from_timestamp = params$fromTimeStamp,
    to_timestamp = params$toTimeStamp,
...
`r if(getOption("PM1_ENABLE")){"### PM 1"}`
```{r}
if (getOption("PM1_ENABLE")) {
  monkeyr::ts_chart(
    observations = wrangled_obs,
    from_timestamp = params$fromTimeStamp,
    to_timestamp = params$toTimeStamp,
...
`r if(getOption("PM2_5_ENABLE")){"### PM 2.5"}`
```{r}
if (getOption("PM2_5_ENABLE")) {
  monkeyr::ts_chart(
    observations = wrangled_obs,
    from_timestamp = params$fromTimeStamp,
    to_timestamp = params$toTimeStamp,
...
`r if(getOption("PM10_ENABLE")){"### PM 10"}`
```{r}
if (getOption("PM10_ENABLE")) {
  monkeyr::ts_chart(
    observations = wrangled_obs,
    from_timestamp = params$fromTimeStamp,
    to_timestamp = params$toTimeStamp,
...
`r if(getOption("HCHO_ENABLE")){"### Formaldehyde"}`
```{r}
if (getOption("HCHO_ENABLE")) {
  monkeyr::ts_chart(
    observations = wrangled_obs,
    from_timestamp = params$fromTimeStamp,
    to_timestamp = params$toTimeStamp,
    target_variable = "hcho"
  )
}
```
