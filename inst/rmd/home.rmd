...
params:
  filtered_obs:             "../dummy-data/energymate_home/obs.csv"
  filtered_weather:         "../dummy-data/energymate_home/weather.csv"
  filtered_devices:         "../dummy-data/energymate_home/dev.csv"
  filtered_interventions:   "../dummy-data/energymate_home/interv.csv"
  report_params:            "-map-"                                            
  fromTimeStamp:            1662958317
  toTimeStamp:              1665546717
---
