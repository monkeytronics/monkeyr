...
params:
  filtered_obs:             "../test-data/monkey_b/obs.csv"
  filtered_weather:         "../test-data/monkey_b/weather.csv"
  filtered_devices:         "../test-data/monkey_b/dev.csv"
  filtered_interventions:   "../test-data/monkey_b/interv.csv"
  report_params:            "-map-"                                            
